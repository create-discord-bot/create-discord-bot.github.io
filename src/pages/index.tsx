      ...
      <main>
        ...
        <figure className={styles.adder}>
          <div>
                ...
                <p>
                  create-discord-bot lets you create a Discord bot faster than you can read this entire page.
                  It lets you <strong>focus on development and not tooling or scaffolding</strong>
                  <br />
                  <br />
